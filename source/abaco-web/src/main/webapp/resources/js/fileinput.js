...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        msgFilesTooMany: 'Numero de imagens selecionadas para upload <b>({n})</b> excedem o limite de <b>{m}</b>. Por favor escolha novamente!',
        msgFileNotFound: 'File "{name}" not found!',
        msgFileNotReadable: 'File "{name}" is not readable.',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'An error occurred while reading the file "{name}".',
        msgInvalidFileType: 'Tipo invalido para o arquivo "{name}". Somente arquivos "{types}" sao suportados.',
        msgInvalidFileExtension: 'Invalid extension for file "{name}". Only "{extensions}" files are supported.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Erro no Upload</span>',
